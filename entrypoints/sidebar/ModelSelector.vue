<template>
  <el-dialog v-model="visible" :title="t('model.selectModel')" width="600px">
        ...
        <div class="model-list">
          ...
          >
            ...
            <div class="model-actions">
              ...
              <el-button size="small" @click="handleConfigureModel(model)">
                {{ hasApiKey(model.id) ? t('model.editKey') : t('model.configure') }}
              </el-button>
              <el-tag v-if="currentModelId === model.id" type="success" size="small">
                {{ t('model.active') }}
              </el-tag>
            </div>
          </div>
      ...
      <el-tab-pane :label="t('model.customModels')" name="custom">
        <div class="model-list">
          ...
          >
            ...
            <el-button-group>
              <el-button size="small" @click="selectModel(model)">
                {{ t('model.select') }}
              </el-button>
    ...
    <AddModelDialog v-model:visible="showAddModel" @add="handleAddModel" />
